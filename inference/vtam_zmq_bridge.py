    ...
    def __init__(self, use_d405: bool = True, *args, **kwargs):
        ...
        class MockClient:
            def __init__(self):
                ...
                self.head_camera_pose = np.eye(4)
                self.robot = type('Obj', (), {'arm': None, 'base': None, 'head': None})()
            def in_manipulation_mode(self): return True
            def in_navigation_mode(self): return False
            def at_goal(self): return True
            def last_motion_failed(self): return False
            def get_pose_graph(self): return None

        self.client = MockClient()
        self.use_d405 = use_d405

        # ROS2 client interface
        self.client = type('MockClient', (), {'robot': type('MockRobot', (), {'arm': None, 'base': None, 'head': None})()})()
        self.use_d405 = use_d405
