...
This project builds on [UMI](https://umi-gripper.github.io),  [stretch_ai](https://github.com/hello-robot/stretch_ai), and [eFlesh](https://github.com/notvenky/eFlesh). See [Citations](#citations) below.
